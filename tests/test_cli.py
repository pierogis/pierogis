...
def test_pyrogis_sort():
    main(args=["sort", "resources/gnome.jpg"])
...
def test_pyrogis_sort_options():
    ...
    """
    main(args=["sort", "resources/gnome.jpg", "-u", "200", "-l", "20", "-t", "2", "--ccw"])
...
def test_pyrogis_quantize():
    main(args=["quantize", "resources/gnome.jpg"])
...
def test_pyrogis_threshold():
    main(args=["threshold", "resources/gnome.jpg"])
...
def test_pyrogis_resize():
    main(args=["resize", "resources/gnome.jpg"])
...
def test_pyrogis_chef():
    main(args=["chef", "resources/gnome.jpg", "sort; quantize"])

    assert os.path.isfile("cooked.png")
    os.remove("cooked.png")

def test_pyrogis_chef_txt():
    main(args=["chef", "resources/gnome.jpg", "resources/recipe.txt"])
...
def test_pyrogis_plate_options():
    main(args=["plate", "resources", "--fps", "25", "--duration", "20", "--no-optimize"])
...
def test_pyrogis_image_with_output():
    main(args=["resize", "resources/gnome.jpg", "--output", "output.png"])
...
def test_pyrogis_animation():
    ...
    """
    main(args=["resize", "resources/octo.mp4"])
...
def test_pyrogis_animation_with_output_gif():
    ...
    """
    main(args=["resize", "resources/octo.mp4", "--output", "output.gif"])
...
def test_pyrogis_animation_with_output_mp4():
    ...
    and providing an output gif filename
    """
    main(args=["resize", "resources/octo.mp4", "--output", "cooked.mp4"])
...
def test_pyrogis_animation_frames():
    ...
    """
    main(args=["resize", "resources/octo.mp4", "--frames"])
...
def test_pyrogis_animation_frames_with_output_dir():
    ...
    """
    main(args=["resize", "resources/octo.mp4", "--frames", "--output", "frames"])
